...
class orig : public inputTransMethod{
    ...
    orig(){
        ...
        maxSide = 262142;
        maxChannel = 512000;
        strcpy(outFileName, "M1_orig.bin");
    }
...
class new1 : public inputTransMethod{
    ...
    new1(){
        ...
        maxBatch = 65535;
        maxChannel = 512000;
        strcpy(outFileName, "M1_new1.bin");
    }
    virtual void execut(testCase tc) {
        wino_input_trans_nchw_suitFor128_new1<<<dim3(tc.chn,(blockn*blockn/64),tc.bat4Conv),dim3(8,8)>>>(tc.inside, inside_beta, MSize, KSize, padding, tc.input_gpu, inputTran_gpu);
    }
};
...
class new2 : public inputTransMethod{
    ...
    new2(){
        ...
        maxSide = 65535;
        maxBatch = 65535;
        strcpy(outFileName, "M1_new2.bin");
    } 
    virtual void execut(testCase tc) {
...
class new4 : public inputTransMethod{
    ...
    new4(){
        ...
        maxSide = 65535;
        maxBatch = 65535;
        strcpy(outFileName, "M1_new4.bin");
    } 
    virtual void execut(testCase tc) {
        wino_input_trans_nchw_suitFor128_new4<<<dim3(tc.chn,(blockn*blockn/64),tc.bat4Conv),dim3(8,8)>>>(tc.inside, inside_beta, MSize, KSize, padding, tc.input_gpu, inputTran_gpu);
    }
};
