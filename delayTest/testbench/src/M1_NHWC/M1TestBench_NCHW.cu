...
int main(){
    ...
    teCase[0] = new testCase(fileName, 224, 8, 1, 64, 1);      // size, batch, chn
    teCase[1] = new testCase(fileName, 224, 8, 64, 64, 2);

    teCase[2] = new testCase(fileName, 112, 8, 64, 128, 3);
    teCase[3] = new testCase(fileName, 112, 8, 128, 128, 4);

    teCase[4] = new testCase(fileName, 56, 8, 128, 256, 5);
    teCase[5] = new testCase(fileName, 56, 8, 256, 256, 6);

    teCase[6] = new testCase(fileName, 28, 8, 256, 512, 7);
    teCase[7] = new testCase(fileName, 28, 8, 512, 512, 8);

    teCase[8] = new testCase(fileName, 14, 8, 512, 512, 9);
